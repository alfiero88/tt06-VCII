...
C {devices/ammeter.sym} 230 -140 0 0 {name=Vmeas1 savecurrent=true}
C {devices/lab_pin.sym} 230 30 2 0 {name=p18 sig_type=std_logic lab=res1}
C {devices/lab_pin.sym} 260 -810 2 0 {name=p20 sig_type=std_logic lab=res1}
...
C {sky130_fd_pr/res_generic_l1.sym} 260 -730 0 0 {name=R1
W=1
L=10
