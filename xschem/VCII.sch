...
C {devices/vsource.sym} 60 -450 0 0 {name=V1 value=1.8 savecurrent=false}
C {devices/vsource.sym} 60 -370 0 0 {name=V2 value=0 savecurrent=false}
...
C {devices/simulator_commands_shown.sym} -370 350 2 1 {name=COMMANDS
simulator=ngspice
only_toplevel=false 
value="
*save
...
C {devices/launcher.sym} -180 -150 0 0 {name=h1
descr="Annotate OP" 
tclcommand="set show_hidden_texts 1; xschem annotate_op"
}
C {devices/vsource.sym} 370 150 0 0 {name=V3 value=0.9 savecurrent=false}
...
C {devices/isource.sym} 850 150 0 0 {name=I1 value="0 ac 1 0
+ sin(0 2u 100K 0 0 0)"}
C {devices/res.sym} 1070 140 0 0 {name=R2
value=10k
footprint=1206
device=resistor
m=1}
C {devices/lab_pin.sym} 370 90 1 0 {name=p13 sig_type=std_logic lab=Ref}
C {devices/lab_pin.sym} 850 200 3 0 {name=p14 sig_type=std_logic lab=Ref}
C {devices/ammeter.sym} 1070 220 0 0 {name=Vmeas savecurrent=true}
